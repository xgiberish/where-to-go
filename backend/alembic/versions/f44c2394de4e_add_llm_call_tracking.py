...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('hypothetical_claude_haiku_cost', sa.Numeric(precision=10, scale=8), nullable=False),
        sa.Column('hypothetical_claude_sonnet_cost', sa.Numeric(precision=10, scale=8), nullable=False),
        sa.Column('hypothetical_gemini_flash_cost', sa.Numeric(precision=10, scale=8), nullable=False),
    ...
    # server_default='0' handles any pre-existing agent_run rows
    op.add_column('agent_runs', sa.Column('total_tokens', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('agent_runs', sa.Column('total_actual_cost', sa.Numeric(precision=10, scale=8), nullable=False, server_default='0'))
    op.add_column('agent_runs', sa.Column('total_hypothetical_claude_cost', sa.Numeric(precision=10, scale=8), nullable=False, server_default='0'))
    op.add_column('agent_runs', sa.Column('total_hypothetical_gemini_cost', sa.Numeric(precision=10, scale=8), nullable=False, server_default='0'))
